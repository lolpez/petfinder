<?php
$this->assign('title','FIND MY PET | Razas');
$this->assign('nav','razas');
$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
    $LAB.script("libs/View/scripts/razas.js").wait(function(){
...
<button id="newRazaButton" class="md-btn md-fab md-fab-bottom-right pos-fix blue waves-effect"><i class="mdi-content-add i-24"></i></button>
<div class="row">
    <div class="col-xs-4">
...
<script type="text/template" id="razaCollectionTemplate">
    ...
    <div class="table-responsive">
        <table class="collection table table-bordered table-hover">
            <thead>
            <tr>
                <th id="header_Pkraza">ID raza<% if (page.orderBy == 'Pkraza') { %> <i class='fa fa-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_Nombre">Nombre<% if (page.orderBy == 'Nombre') { %> <i class='fa fa-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
                <th id="header_FktipoMascota">Tipo Mascota<% if (page.orderBy == 'FktipoMascota') { %> <i class='fa fa-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
            </tr>
            </thead>
            <tbody>
...
<script type="text/template" id="razaModelTemplate">
    <form onsubmit="return false;">
        <fieldset>
            <span class="hidden" id="pkraza"><%= _.escape(item.get('pkraza') || '') %></span>
            <div class="row">
                <div class="col-xs-6">
        ...
        <fieldset>
            <div class="control-group dropdown">
                ...
                <ul class="dropdown-menu animated fadeIn">
                    <li><a href="#" id="confirmDeleteRazaButton"><i class="fa fa-check"></i></a></li>
                    <li><a href="#" id="cancelDeleteRazaButton"><i class="fa fa-times"></i></a></li>
                </ul>
            </div>
        </fieldset>
    </form>
...
<!-- modal edit dialog -->
<div class="modal fade" id="razaDetailDialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <a class="close" data-dismiss="modal">&times;</a>
                <h3>
                    <i class="icon-edit"></i> Editar Raza
            ...
            <div class="modal-footer">
                ...
                <button md-ink-ripple="" id="saveRazaButton" class="btn btn-fw btn-success waves-effect waves-effect"><i class="fa fa-floppy-o fa-fw"></i> Guardar</button>
            </div>
        </div>
    </div>
</div>
