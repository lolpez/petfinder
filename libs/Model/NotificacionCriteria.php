...
require_once("DAO/NotificacionCriteriaDAO.php");

/**
 * The NotificacionCriteria class extends NotificacionDAOCriteria and is used
 ...
 * @version 1.0
 */
class NotificacionCriteria extends NotificacionCriteriaDAO
{
