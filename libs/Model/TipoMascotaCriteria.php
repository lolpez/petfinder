...
require_once("DAO/TipoMascotaCriteriaDAO.php");

/**
 * The TipoMascotaCriteria class extends TipoMascotaDAOCriteria and is used
 ...
 * @version 1.0
 */
class TipoMascotaCriteria extends TipoMascotaCriteriaDAO
{
