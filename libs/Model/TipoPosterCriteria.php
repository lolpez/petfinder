...
require_once("DAO/TipoPosterCriteriaDAO.php");

/**
 * The TipoPosterCriteria class extends TipoPosterDAOCriteria and is used
 ...
 * @version 1.0
 */
class TipoPosterCriteria extends TipoPosterCriteriaDAO
{
