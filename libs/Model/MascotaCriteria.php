...
require_once("DAO/MascotaCriteriaDAO.php");

/**
 * The MascotaCriteria class extends MascotaDAOCriteria and is used
 ...
 * @version 1.0
 */
class MascotaCriteria extends MascotaCriteriaDAO
{
